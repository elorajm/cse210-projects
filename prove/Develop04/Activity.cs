...
public void DisplayStartingMessage(string activityName,string message){
    ...
    _activityName = activityName;
    Console.Clear();
    Console.WriteLine($"Welcome to the {_activityName} Activity. You're about to take a positive step towards mindfulness and peace.");
    Console.WriteLine();
    Console.WriteLine(_description);
    Console.WriteLine();
    Console.WriteLine("Excited to get started! How many seconds would you like your session to last?");
